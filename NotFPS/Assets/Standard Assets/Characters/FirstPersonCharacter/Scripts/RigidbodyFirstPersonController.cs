...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            public float ForwardSpeed = 20.0f;   // Speed when walking forward
            public float BackwardSpeed = 10.0f;  // Speed when walking backwards
            public float StrafeSpeed = 15.0f;    // Speed when walking sideways
            public float RunMultiplier = 3.0f;   // Speed when sprinting
